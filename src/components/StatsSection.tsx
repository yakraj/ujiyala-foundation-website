      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center">
          ...
          <div className="group p-8 rounded-2xl bg-white/5 backdrop-blur-sm border border-white/10 hover:bg-white/10 transition-all duration-300 transform hover:-translate-y-2">
            ...
            <h3 className="text-5xl font-extrabold text-white mb-3 tracking-tight">$1.2M+</h3>
            <p className="text-gray-300 uppercase tracking-widest text-sm font-semibold">Total Expenses in Aid</p>
          </div>
          ...
          <div className="group p-8 rounded-2xl bg-white/5 backdrop-blur-sm border border-white/10 hover:bg-white/10 transition-all duration-300 transform hover:-translate-y-2">
            ...
            <h3 className="text-5xl font-extrabold text-white mb-3 tracking-tight">5,000+</h3>
            <p className="text-gray-300 uppercase tracking-widest text-sm font-semibold">Active Members</p>
          </div>
          ...
          <div className="group p-8 rounded-2xl bg-white/5 backdrop-blur-sm border border-white/10 hover:bg-white/10 transition-all duration-300 transform hover:-translate-y-2">
            ...
            <h3 className="text-5xl font-extrabold text-white mb-3 tracking-tight">$1.5M+</h3>
            <p className="text-gray-300 uppercase tracking-widest text-sm font-semibold">Donations Received</p>
          </div>
