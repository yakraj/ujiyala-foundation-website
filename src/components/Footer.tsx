    ...
    <footer className="bg-secondary text-white pt-16 pb-8 border-t-4 border-primary">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          {/* About */}
          <div>
            <h3 className="text-2xl font-bold mb-6 text-white ujiyala-font">
              Ujiyala Foundation
            </h3>
            <p className="text-gray-300 text-sm leading-relaxed mb-6">
              Dedicated to spreading hope and providing support to those in
              need. From feeding the hungry to educational support, we are here
        ...
        <div className="border-t border-gray-700 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-gray-400">
            &copy; 2025 <span className="ujiyala-font">Ujiyala Foundation</span>
            . All rights reserved.
          </p>
