...
const works = [
  {
    ...
    description:
      "Built check dams and rainwater harvesting systems in drought-prone villages to ensure year-round water availability for farming and drinking.",
  ...
  },
  {
    ...
    description:
      "Provided nutritious cooked meals and dry ration kits to over 500 families struggling with food insecurity in urban slum areas.",
  ...
  },
  {
    ...
    description:
      "Organized a comprehensive health camp providing free checkups, eye tests, and essential medicines to 300+ villagers with limited healthcare access.",
    category: "Healthcare",
  },
  {
    id: "project-vidya",
    ...
    description:
      "Distributed complete school kits including bags, notebooks, and stationery to 200+ children to encourage school enrollment and attendance.",
    category: "Education",
  },
];
    ...
    <div className="max-w-7xl mx-auto px-4">
      <div className="text-center mb-16">
        ...
        <p className="text-lg text-gray-600 max-w-2xl mx-auto">
          Transparency in action. Explore our recent projects and see how your
          contributions are making a tangible difference on the ground.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
        {works.map((work, idx) => (
          <div
            key={idx}
            className="bg-white rounded-3xl shadow-xl overflow-hidden flex flex-col md:flex-row group hover:shadow-2xl transition-all duration-500 border border-gray-100"
          >
            {/* Image Section */}
      ...
      <div className="mt-20 bg-secondary rounded-3xl p-8 sm:p-12 text-center text-white shadow-2xl relative overflow-hidden">
        ...
        <p className="text-gray-300 mb-8 max-w-2xl mx-auto relative z-10">
          We are always looking for volunteers and partners to expand our reach.
          Join us in bringing light to more lives.
        </p>
        <div className="flex flex-wrap justify-center gap-4 relative z-10">
          <a
            href="/volunteer"
            className="bg-primary hover:bg-red-600 text-white font-bold py-3 px-8 rounded-xl transition-all shadow-lg active:scale-95"
          >
            Join as Volunteer
          </a>
          <a
            href="/donate"
            className="bg-white hover:bg-gray-100 text-secondary font-bold py-3 px-8 rounded-xl transition-all shadow-lg active:scale-95"
          >
            Support a Project
          </a>
        </div>
