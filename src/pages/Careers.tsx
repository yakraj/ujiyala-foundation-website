  ...
  const benefits = [
    {
      ...
      description:
        "Every day, you'll be contributing to projects that directly impact lives in rural Maharashtra.",
    },
    {
      icon: <Users className="w-8 h-8 text-primary" />,
      title: "Collaborative Culture",
      description:
        "Work with a passionate team of experts, volunteers, and community leaders.",
    },
    {
      icon: <Globe className="w-8 h-8 text-primary" />,
      title: "Growth Opportunities",
      description:
        "We invest in our people through training, mentorship, and diverse project exposure.",
    },
  ];
      ...
      <section className="bg-secondary py-20 text-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          <h1 className="text-4xl md:text-6xl font-black mb-6">
            Join the <span className="ujiyala-font text-primary">Ujiyala</span>{" "}
            Team
          </h1>
          <p className="text-xl text-gray-200 max-w-3xl mx-auto leading-relaxed">
            Be part of a movement that is bringing light and hope to rural
            communities. We're looking for passionate individuals to help us
            scale our impact.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-12">
            {benefits.map((benefit, index) => (
              <div
                key={index}
                className="bg-white p-10 rounded-3xl shadow-xl shadow-secondary/5 border border-gray-100 hover:scale-105 transition-transform duration-300"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            {openings.map((job, index) => (
              <div
                key={index}
                className="group border border-gray-100 rounded-[2rem] p-8 hover:border-primary hover:shadow-2xl hover:shadow-primary/5 transition-all duration-300 flex flex-col md:flex-row justify-between items-center gap-6"
              >
